...
(function(){
    ...
    function isProtectedElement(el){return !el || !el.closest || !!el.closest('header,.site-header,.header-top,.header-tools,.header-nav,.main-nav,.nav-inner,.nav-actions,.brand,.brand-logo,.brand-text,.language-dropdown,.language-current,.language-menu,.social-links,footer,.site-footer,.footer-brand,.footer-social,.auth-backdrop,.site-search-backdrop');}
